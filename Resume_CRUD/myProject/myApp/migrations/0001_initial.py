    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Profile_pic', models.ImageField(null=True, upload_to='Medis/Profile_pic')),
                ...
                ('grndrt_type', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('others', 'Others')], max_length=100, null=True)),
